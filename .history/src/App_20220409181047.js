      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <h2>Categories</h2>
            <p>Breaking down our searches into categories can help us find jobs specific to our experience, education, etc. This allows us to include several different keywords that can be used to describe the given category (i.e.: "junior", "entry level", "recent grad".            
            </p>
    ...
    <div className="keyword-form">
      ...
      {showNewCategoryButton === true && (
        <div className="what-why-info">
              ...
              <p>
                Boolean searches are used by recruiters to identify high quality candidates.
              </p>
            
              <p>Just as recruiters use search booleans to find applicants that fit the job description, job seekers can use them to narrow down search results to find jobs tailored to their needs. It's time for those of us on the job hunt to start utilizing their tools to our own advantage to find jobs that fit our needs.
          </p>
