...
<button onClick={submitCategory}>Submit</button>;
      ...
      {showNewCategoryButton === true && (
        <div className="what-why-info">
              <h3>It's time to starting finding jobs tailored to you</h3>
              <h4>
                Boolean searches used by recruiters to identify candidates that meet job criteria.
              </h4>
            
              <h4>Just as boolean searches help recruiters, candidates can use them to filter out jobs that aren't a good fit. It's time for those of us on the job hunt to start utilizing their tools to our own advantage to find jobs tailored to us.
            </h4>
