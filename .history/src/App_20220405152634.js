      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <p>Breaking our boolean searches down into categories can help us find jobs specific to our experience, tech stack, education, etc.. The benefit of this we can include multiple keywords that describe the same thing (i.e. "entry level", "junior", "recent grad", or "early career").</p>
          </div>
