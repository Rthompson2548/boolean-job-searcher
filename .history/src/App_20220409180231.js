      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <h2>Categories</h2>
            <p>Breaking down our searches into categories can help us find jobs specific to our experience, tech stack, education, etc.. The benefit of this we can include multiple keywords that describe the same thing (i.e. "entry level", "junior", "recent grad", or "early career").</p>
