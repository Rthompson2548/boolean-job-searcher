      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <h2>Categories</h2>
            <p>
              Breaking our searches down into categories allows us to include several keywords that may describe the same thing (i.e.: "junior" or "early career" for experience, and "remote" or "virtual" for location).
            </p>
