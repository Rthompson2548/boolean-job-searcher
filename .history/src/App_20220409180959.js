    ...
    <div className="keyword-form">
      ...
      {showNewCategoryButton === true && (
        <div className="what-why-info">
              ...
              <p>Just as recruiters use search booleans are used to find candidates, job seekers can use them to narrow down search results to their needs. It's time for those of us on the job hunt to start utilizing their tools to our own advantage to find jobs that fit our needs.
          </p>
