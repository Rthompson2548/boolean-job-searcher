      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <h2>Categories</h2>
            <p>
              Breaking our searches down into categories allows us to include several keywords that may be used to describe the same thing in each (i.e.: "junior" or "entry level" for experience, and "remote" or "virtual"
            </p>
