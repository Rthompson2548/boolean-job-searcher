      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <p>Breaking down our boolean searches into categories can help us specify our experience, tech stack, etc., even if several words can be used to describe the same thing</p>
            <p>For example, jobs entry level positions may be described as "entry level", "junior", "recent grad", or "early career", and more.</p>
          </div>
