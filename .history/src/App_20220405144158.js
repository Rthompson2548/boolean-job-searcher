      ...
      {showNewCategoryButton === true && (
        ...
        <div className="what-why-info">
          {/* <hr /> */}
              ...
              <h4>Why?</h4>
              <p>
                Just as boolean searches help recruiters, candidates can use them to filter out jobs that aren't a good fit. It's time for those of us on the job hunt to start utilizing their tools to our own advantage to find jobs tailored to us.
          </p>
