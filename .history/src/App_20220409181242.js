      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <h2>Categories</h2>
            <p>Breaking our searches into categories can help us find jobs specific to our experience, education, etc. This allows us to include several different keywords that can be used to describe the given category (i.e.: "junior", "entry level", "recent grad".            
            </p>
