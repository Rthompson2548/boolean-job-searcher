      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <p>Breaking down our boolean searches into categories can help us specify our experience, tech stack, etc., even if there are several keywords that can be used to describe the same things</p>
            <p>For example, jobs that require less experience may include "entry level", "junior" or "recent grad", "early career", and more.</p>
          </div>
