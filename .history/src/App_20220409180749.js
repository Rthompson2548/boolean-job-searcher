    ...
    <div className="keyword-form">
      ...
      {showNewCategoryButton === true && (
        <div className="what-why-info">
              ...
              <p>
                Boolean searches are used by recruiters to identify candidates that meet job criteria.
              </p>
            
              <p>Just as boolean searches help recruiters, candidates can use them to filter out jobs that aren't a good fit. It's time for those of us on the job hunt to start utilizing their tools to our own advantage to find jobs that fit our needs.
            </p>
