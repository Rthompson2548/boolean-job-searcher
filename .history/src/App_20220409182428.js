      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <h2>Categories</h2>
            <p>
              Breaking our searches down into categories allows us to include several keywords that may describe the same thing (i.e.: "junior" or "entry level" for experience, and "developer" or "engineer" for location).
            </p>
