      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <h2>Categories</h2>
            <p>
              Breaking our searches down into categories allows us to include a variety of keywords that may be used to describe each (i.e.: "junior" or "entry level" for experience, and "remote" or "virtual"
            </p>
