...
<button onClick={submitCategory}>Submit</button>;
      ...
      {showNewCategoryButton === true && (
        ...
        <div className="what-why-info">
          {/* <hr /> */}
              <h2>It's time to improve your job search</h2>
              <p>
                Boolean searches are heavily used among recruiters to identifying whether or not they meet various criteria specific
                to the job.
              </p>
              <h4>Why?</h4>
              <p>
                Just as boolean searches help recruiters filter out unfit candidates, candidates can use them to filter out jobs that aren't a good fit. It's time for those of us on the job hunt to start utilizing their tools to our own advantage to find jobs tailored to us.
          </p>
