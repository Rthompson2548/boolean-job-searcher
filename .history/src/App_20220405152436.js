      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <p>Breaking down our boolean searches into categories can help us specify our experience, tech stack, etc., even if several words can be used to describe the same thing (i.e. "entry level", "junior", "recent grad", or "early career").</p>
          </div>
