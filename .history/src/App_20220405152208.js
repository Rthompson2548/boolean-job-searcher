      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <p>Breaking down our boolean searches into categories can help us specify , even if there are several keywords that can be used to describe the same things</p>
