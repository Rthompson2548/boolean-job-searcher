      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <p>Breaking down our boolean searches into categories can help us find keywords that fit our needs, even if there are several keywords that can be used to des</p>
