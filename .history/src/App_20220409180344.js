      ...
      {categoryOptions === true && (
        <div>
          ...
          <div className="what-why-info">
            <h2>Categories</h2>
            <p>Breaking down our searches into categories can help us find jobs specific to our experience, education, etc. This allows us to include multiple words to  
