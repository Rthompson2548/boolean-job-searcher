    ...
    <div className="keyword-form">
      ...
      {showNewCategoryButton === true && (
        <div className="what-why-info">
              ...
              <p>Just as recruiters use search booleans to find applicants that fit the job description, job seekers can use them to narrow down search results to find jobs that their needs. It's time for those of us on the job hunt to start utilizing their tools to our own advantage to find jobs that fit our needs.
          </p>
