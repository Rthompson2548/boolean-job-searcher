...
<button onClick={submitCategory}>Submit</button>;
      ...
      <div>
        ...
        <p>
          Boolean searches are heavily used among recruiters for sourcing great candidates by identifying whether or not they meet various criteria specific to the job. 
        </p>
        <p>Now, it's time for you to use it to your own advantage to find positions tailored to your experience </p>
      </div>
